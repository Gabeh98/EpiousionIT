...
public class TestaHeranca {
    ...
    public static void main(String args[]) {
        ...
        ContaEspecial contaEsp1 = new ContaEspecial(0,"Conta especial",cliente1,ag1); 
        
        ContaEspecial contaEsp2 = new ContaEspecial(10,"Conta especial2",cliente2,ag1); 
        
        ContaPoupanca contaPoup = new ContaPoupanca(1,"Poupanca",cliente1,ag1,"dia 15");
